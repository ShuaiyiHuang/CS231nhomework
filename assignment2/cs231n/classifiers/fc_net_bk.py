...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        # print (hidden_dims,self.num_layers)
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers):
            ...
            W=self.params[nameW]
            b=self.params[nameb]
            # print(nameW,W.shape,nameb,b.shape)
            if i==0:
            ...
            #     # print('finalout in layer',str(i+1),finalout.shape)
            elif i==self.num_layers-1:
        ...
        # print(cache_all['out_l1'].shape,cache_all['out_l2'].shape,cache_all['out_l3'].shape)
        scores=cache_all['out_l'+str(self.num_layers)]
        # print('scores',scores)
        # print('finalout',finalout)
        # print('gap:',np.linalg.norm(scores-finalout))
...
# def affin_bn_relu_forward(x,w,b):
#     fc1, cache_fc1 = affine_forward(x, w, b)
#
#     relu1, cache_relu1 = relu_forward(fc1)
#     out=relu1
